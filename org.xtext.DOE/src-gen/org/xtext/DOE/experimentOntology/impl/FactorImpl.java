 ...
 * <ul>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.FactorImpl#getFactorName <em>Factor Name</em>}</li>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.FactorImpl#getFactorType <em>Factor Type</em>}</li>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.FactorImpl#getFactorType1 <em>Factor Type1</em>}</li>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.FactorImpl#getFactorValue <em>Factor Value</em>}</li>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.FactorImpl#getFactorProperties <em>Factor Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FactorImpl extends MinimalEObjectImpl.Container implements Factor
{
  ...
  {
    return ExperimentOntologyPackage.Literals.FACTOR;
  }
  ...
  public void setFactorName(String newFactorName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.FACTOR__FACTOR_NAME, oldFactorName, factorName));
  }
  ...
  public void setFactorType(VariableType newFactorType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.FACTOR__FACTOR_TYPE, oldFactorType, factorType));
  }
  ...
  public void setFactorType1(String newFactorType1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.FACTOR__FACTOR_TYPE1, oldFactorType1, factorType1));
  }
  ...
  public NotificationChain basicSetFactorValue(Values newFactorValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.FACTOR__FACTOR_VALUE, oldFactorValue, newFactorValue);
  ...
  public void setFactorValue(Values newFactorValue)
  {
    if (newFactorValue != factorValue)
    {
      ...
      if (factorValue != null)
        msgs = ((InternalEObject)factorValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExperimentOntologyPackage.FACTOR__FACTOR_VALUE, null, msgs);
      if (newFactorValue != null)
        msgs = ((InternalEObject)newFactorValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExperimentOntologyPackage.FACTOR__FACTOR_VALUE, null, msgs);
      msgs = basicSetFactorValue(newFactorValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.FACTOR__FACTOR_VALUE, newFactorValue, newFactorValue));
  }
  ...
  public EList<properties> getFactorProperties()
  {
    ...
    {
      factorProperties = new EObjectContainmentEList<properties>(properties.class, this, ExperimentOntologyPackage.FACTOR__FACTOR_PROPERTIES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExperimentOntologyPackage.FACTOR__FACTOR_VALUE:
        return basicSetFactorValue(null, msgs);
      case ExperimentOntologyPackage.FACTOR__FACTOR_PROPERTIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExperimentOntologyPackage.FACTOR__FACTOR_NAME:
        return getFactorName();
      case ExperimentOntologyPackage.FACTOR__FACTOR_TYPE:
        return getFactorType();
      case ExperimentOntologyPackage.FACTOR__FACTOR_TYPE1:
