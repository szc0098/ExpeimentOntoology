 ...
 * <ul>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.IterationImpl#getIterations <em>Iterations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IterationImpl extends MinimalEObjectImpl.Container implements Iteration
{
  ...
  {
    return ExperimentOntologyPackage.Literals.ITERATION;
  }
  ...
  public void setIterations(int newIterations)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.ITERATION__ITERATIONS, oldIterations, iterations));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExperimentOntologyPackage.ITERATION__ITERATIONS:
