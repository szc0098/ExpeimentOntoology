 ...
 * <ul>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.ReactionImpl#getAgent1 <em>Agent1</em>}</li>
 *   <li>{@link org.xtext.DOE.experimentOntology.impl.ReactionImpl#getAgent <em>Agent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionImpl extends MinimalEObjectImpl.Container implements Reaction
{
  ...
  {
    return ExperimentOntologyPackage.Literals.REACTION;
  }
  ...
  public void setAgent1(String newAgent1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.REACTION__AGENT1, oldAgent1, agent1));
  }
  ...
  public void setAgent(String newAgent)
  {
    ...
    agent = newAgent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExperimentOntologyPackage.REACTION__AGENT, oldAgent, agent));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExperimentOntologyPackage.REACTION__AGENT1:
        return getAgent1();
      case ExperimentOntologyPackage.REACTION__AGENT:
        return getAgent();
    }
