...
public class ExperimentOntologySwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ExperimentOntologyPackage.EXPERIMENT_ONTOLOGY:
      {
      ...
      case ExperimentOntologyPackage.TEMPORAL_PATTERN:
      {
      ...
      case ExperimentOntologyPackage.EVENT:
      {
      ...
      case ExperimentOntologyPackage.RELATIONAL_QUERY:
      {
